...
clear
echo "==== MENU DE SCRIPTS DISPONIVEIS - GLENN ===="
echo

i=1
declare -A scripts

# Lista todos os arquivos .sh da pasta (exceto o proprio menu)
...
if [[ "$opcao" == "99" ]]; then
    ...
    if [[ -x "$script" ]]; then
        ...
        echo "Script nao encontrado ou sem permissao de execucao."
        sleep 2
        exec "$0"
    fi
